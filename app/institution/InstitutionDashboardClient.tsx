          ...
          <div className="mb-8 grid gap-4 sm:grid-cols-3 lg:grid-cols-6">
            <label className="space-y-2">
              ...
              <select
                ...
                className="w-full rounded-3xl border border-slate-300 bg-white px-4 py-3 text-slate-900 outline-none transition focus:border-slate-500 focus:ring-2 focus:ring-slate-200/70 disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-50 dark:focus:border-slate-500 dark:focus:ring-slate-500/20"
              >
                {selectedInstitutionOptions.map((option) => (
